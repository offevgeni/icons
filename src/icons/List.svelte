...
<svg
  ...
  viewBox="0 -4.5 31 31"
  fill={color}
  class="icon icon-list {className}"
  {...props}
>
  <title>list</title>
    ...
    <g id="Page-1" stroke="none" stroke- fill="none" fill-rule="evenodd" sketch:type="MSPage">
        <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-206.000000, -626.000000)" fill={color}>
